...
@section('content')
    <div class="container">
        <div class="justify-items-center mb-10">
            <h2 class="text-4xl font-extrabold dark:text-black">Add To Do</h2>
        </div>
        <div class="">
        ...
        <form class="max-w-md mx-auto" action="{{ route('jadwal.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="relative z-0 w-full mb-5 group" action="{{ route('jadwal.store') }}" method="post">
            ...
            <div class="relative z-0 w-full mb-5 group">
                ...
                <fieldset>
                    <div class="flex items-center my-4">
                        <input id="selesai" type="radio" name="status" value="selesai" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600" checked>
                    ...
                    <div class="flex items-center mb-4">
                        <input id="belum" type="radio" name="status" value="belum" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div class="flex items-center mb-4">
                        <input id="pending" type="radio" name="status" value="pending" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-600 dark:focus:bg-blue-600 dark:bg-gray-700 dark:border-gray-600">
